...
\begin{eg}\label{ct:hilb}
  ...
  \end{itemize}
  By standard linear algebra, any linear map $f:V\to W$ between finite-dimensional inner product spaces has a uniquely defined adjoint\index{adjoint!linear map} $\dgr f:W\to V$, characterized by $\langle f v,w\rangle = \langle v,\dgr f w\rangle$.
