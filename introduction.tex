...
% This enlarges the page by one line in letter format. Use sparingly.
\OPTwidow
...
In type theory, one can have a type whose elements are themselves types; such a type is called a \emph{universe} and is usually denoted by $\UU$.
